...
export function ComprehensivePricing({ onPageChange, coreSolutions, allSolutions }: ComprehensivePricingProps) {
  ...
  const renderPricingCard = (solution: any, model: string) => {
    ...
    switch (model) {
      ...
      case 'rental':
        if (solution.id === 'eventSense') {
          ...
          displayPrice = solution.rentalPrice;
          priceDetails = 'Per month per unit';
          additionalInfo = `Min 5-6 units, ₹${solution.rentalSecurity} security deposit per unit`;
        }
        break;
      case 'demo':
    ...
    return (
      <Card key={solution.id} className="relative border-2 hover:border-primary/30 transition-all duration-300 shadow-lg hover:shadow-xl">
        ...
        <CardContent>
          <div className="space-y-4">
            {/* Pricing Display */}
            <div className="text-center py-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg">
              <div className="text-3xl font-bold text-primary mb-1">{displayPrice}</div>
              <div className="text-sm text-gray-600 font-medium">{priceDetails}</div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>₹10,000 refundable security deposit per device</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-500" />
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              ...
              variant="outline"
              className="border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold px-8 py-3"
            >
              Contact Sales
            </Button>
          </div>
