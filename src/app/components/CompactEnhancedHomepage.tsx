...
interface CompactEnhancedHomepageProps {
  onPageChange: (page: string) => void;
}

export function CompactEnhancedHomepage({ onPageChange }: CompactEnhancedHomepageProps) {
  ...
  const urgencyMessages = [
    "🔥 Demo Options: 15-Day ₹5,000 | 30-Day ₹10,000 with ₹7,000 Purchase Credit",
    "⚡ Fast Track: 48-Hour Installation Available", 
    "🎯 New: Custom Demo ₹10,000 with 70% Purchase Credit",
    "🚀 All Demos: ₹15,000 Refundable Security Deposit"
  ];
        ...
        <div className="container-responsive relative z-10 py-8 lg:py-16">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className={`text-center lg:text-left transform transition-all duration-1000 space-y-4 lg:space-y-6 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              {/* Main Headline - Compact Single Line */}
              <h1 className="text-gray-900 text-center lg:text-left">
                ...
                <span className="block text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold leading-tight">
                  <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
                    AI People Counting That Actually Works
                  </span>
                </span>
              </h1>
